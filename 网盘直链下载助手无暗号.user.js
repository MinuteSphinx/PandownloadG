...
// @description       【网盘直链下载助手】是一款免客户端获取网盘文件下载地址的油猴插件，支持Windows，Mac，Linux，Android等多平台，可使用IDM，XDown等多线程加速工具加速下载，支持RPC协议远程下载。
// @license           AGPL
...
;(function () {
    ...
    function PanHelper() {
        ...
        function addButton() {
            ...
            $dropdownbutton_span.append($apibutton)/*.append($directbutton)*/.append($ariadirectbutton).append($ariarpcbutton);
        ...
        function linkClick(event) {
            ...
            if (id.indexOf('direct') != -1) {
                ...
                tip = '显示网盘网页获取的链接，可以使用右键迅雷或IDM下载，多文件打包(限300k)下载的链接可以直接复制使用';
        ...
        function batchClick(event) {
            ...
            if (id.indexOf('rpc') > 0) {  //ariaAPI下载
                batchLinkList = getAPIBatchLink(linkType);
                tip = '点击按钮发送链接至Aria下载器中<a href="https://www.baiduyun.wiki/zh-cn/rpc.html">详细说明</a>，需配合最新版 <a href="https://www.baiduyun.wiki/zh-cn/assistant.html">[网盘万能助手]</a>，支持本地和远程下载，此功能建议配合超级会员使用';
                if (batchLinkList.length === 0) {
                    Toast.fire({
                        icon: 'error',
                        text: errorMsg.unselected
            ...
            if (id.indexOf('api') != -1) {  //API下载
                batchLinkList = getAPIBatchLink(linkType);
                tip = '请先安装 <a href="https://www.baiduyun.wiki/zh-cn/assistant.html">网盘万能助手</a> <b>v2.3.1</b> 后点击链接下载，若下载失败，请开启 <a href="https://www.baiduyun.wiki/zh-cn/question.html" target="_blank">备用链接</a>，请配合超级会员使用';
                if (batchLinkList.length === 0) {
                    Toast.fire({
                        icon: 'error',
                        text: errorMsg.unselected
    ...
    function PanShareHelper() {
        ...
        function addButton() {
            ...
            $dropdownbutton_span.append($downloadButton).append($linkButton).append($aricRPCButton).append($aricLinkButton);
